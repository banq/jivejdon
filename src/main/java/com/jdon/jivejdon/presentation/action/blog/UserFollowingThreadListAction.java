...
public class UserFollowingThreadListAction extends ModelListAction {
	private final static Logger logger = LogManager.getLogger(UserFollowingThreadListAction.class);
	...
	public PageIterator getPageIterator(HttpServletRequest request, int start, int count) {
		...
		SubscriptionService subscriptionService = (SubscriptionService) WebAppUtil.getService("subscriptionService", this.servlet.getServletContext());
		PageIterator pi = subscriptionService.getThreadListByUserFollowing(userId, start, count);
		return pi;
	}
