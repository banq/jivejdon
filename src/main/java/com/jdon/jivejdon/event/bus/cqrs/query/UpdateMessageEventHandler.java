...
public class UpdateMessageEventHandler implements EventBusHandler {

	protected final ForumFactory forumAbstractFactory;
	private final MessagePageIteratorSolver messagePageIteratorSolver;

	public UpdateMessageEventHandler(ForumFactory forumAbstractFactory, MessagePageIteratorSolver messagePageIteratorSolver) {
