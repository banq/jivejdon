...
public class DelMessageEventHandler implements EventBusHandler {

	protected final ForumFactory forumAbstractFactory;
	private final MessagePageIteratorSolver messagePageIteratorSolver;

	public DelMessageEventHandler(ForumFactory forumAbstractFactory, MessagePageIteratorSolver messagePageIteratorSolver) {
