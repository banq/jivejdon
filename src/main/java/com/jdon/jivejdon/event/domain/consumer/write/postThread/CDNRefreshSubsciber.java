...
@Component("cdnRefreshHelper")
public class CDNRefreshHelper {
	private final static Logger logger = LogManager.getLogger(CDNRefreshHelper.class);
	private final ThreadTimer threadTimer;

	public CDNRefreshHelper(ThreadTimer threadTimer) {
		this.threadTimer = threadTimer;
	}

	@Subscribe
	public void cdnRefresh(String fileurl) {
		threadTimer.offer(new CDNSender(fileurl));
	}

	class CDNSender extends Thread {
		private final String fileurl;

		public CDNSender(String fileurl) {
