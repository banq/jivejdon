...
public class AddReplyMessageEventHandler implements EventBusHandler {

	protected final ForumFactory forumAbstractFactory;
	private final MessagePageIteratorSolver messagePageIteratorSolver;

	public AddReplyMessageEventHandler(ForumFactory forumAbstractFactory, MessagePageIteratorSolver messagePageIteratorSolver) {
