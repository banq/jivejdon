...
var onlinesInf = function (){
   ...
   if (typeof(TooltipManager) == 'undefined') 
    ...
    try{
           ...
           setTimeout(function () { onlineWindow.close(); }, 2*1000);	
    }catch(e){}
}  	
...
function autoCompleteLogin(){
    ...
    if (username != null){    
      ...
      document.getElementById("j_password").value = decode64(password);
  	  document.getElementById("loggedInfo").innerHTML = " 欢迎<a href='" + getContextPath()+"/blog/"+ document.getElementById("j_username").value +"'>" + document.getElementById("j_username").value + "</a>";
   }
}