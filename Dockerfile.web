...
ADD docker/tomcat/jaas.config /usr/local/tomcat/conf/
ADD docker/tomcat/jaas.jar /usr/local/tomcat/lib/

#add javamail and activation.jar
ADD docker/tomcat/email.jar      /usr/local/tomcat/lib/
