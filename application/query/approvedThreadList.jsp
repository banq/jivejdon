            ...
            <div class="zoom-container">
               ...
               <% String thumbthreadIdS = ((Long)pageContext.getAttribute("thumbthreadId")).toString(); %>               
                ...
                <logic:empty name="forumMessage" property="messageUrlVO.imageUrl">        
                    <img id="home-thumbnai" src="https://cdn.jdon.com/simgs/thumb2/<%=1 + (int) (Math.random() * 49)%>.jpg" border="0" class="thumbnail" style="width: 100%;max-height: 500px" fetchpriority="high"/> 
                </logic:empty>                        
              </div>
			      </div>
