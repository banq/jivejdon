  ...
  <div class="linkblock">
    <div class="box">	  
      ...
      <div class="col-lg-3">
        ...
        <div class="col-lg-9">
            <h1 style="font-size: 3rem;margin-top: 2px;"><a href="<%=domainUrl%>/<bean:write name="forumThread" property="threadId"/><bean:write name="forumThread" property="pinyinToken" />.html"   class="hover-preload"><bean:write name="forumThread" property="name"/></a></h1>
            <div class="info">			 
