...
<logic:iterate indexId="i"   id="forumThread" name="threadListForm" property="list" offset="<%=offset%>" length="<%=count%>" >
 ...
 <div class="row">	
 <%}%>
 <div class="col-md-6" style="padding:0px" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
 <li class="box">	
  <div class="linkblock">
     <div class="box">	        
...
var lastImg = thumbImgs[thumbImgs.length - 1];
lastImg.src = '/simgs/thumb/' + (imgCounter % 3) + '.jpg';
imgCounter++;
</script>
            </div>
         </div>
