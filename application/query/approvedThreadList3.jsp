  ...
  <div class="linkblock">
   <div class="box">
    ...
    <div style="position: relative;"  class="zoom-container">           
       ...
       %>     
        <img id="home-thumbnai" src='<%=imgeUrl%>' border="0" class="img-thumbnail img-responsive" style="height:230px;width:100%"  loading="lazy" onerror="this.src='//cdn.jdon.com/simgs/thumb2/<%=java.util.concurrent.ThreadLocalRandom.current().nextInt(49)%>.jpg'"/>
       </a>
