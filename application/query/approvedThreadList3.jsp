   ...
   <div class="box">
    ...
    <div style="position: relative;"  class="zoom-container">           
       <a href='<%=domainUrl%>/tag/<bean:write name="threadTag" property="tagID"/>/'  title="<bean:write name="threadTag" property="title" />">    
        <img id="home-thumbnai" src='https://static.jdon.com/simgs/thumb2/<%=java.util.concurrent.ThreadLocalRandom.current().nextInt(5)%>.jpg' border="0" class="img-thumbnail img-responsive" style="height:210px;width:100%"  loading="lazy" />
      </a>
