...
<%
 ...
 <li class="box">	
  <div class="linkblock">
     <div class="box">	             
        <section> 
         <h3 class="vid-name"><a onclick="showDialog('dialog2', '<%=request.getContextPath()%>/<bean:write name="forumThread" property="threadId"/>.html#messageListBody')" class="hover-preload"><bean:write name="forumThread" property="name"/></a></h3>
