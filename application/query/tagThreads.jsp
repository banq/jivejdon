...
<logic:notEqual name="threadCount" value="0">
    ...
    <logic:iterate indexId="i"   id="forumThread" name="threadListForm" property="list" length='<%=coutlength%>' >
        <li class="fa fa-circle-o"> <a  class="smallgray" href="<%=request.getContextPath()%>/<bean:write name="forumThread" property="threadId"/><bean:write name="forumThread" property="pinyinToken" />.html"
