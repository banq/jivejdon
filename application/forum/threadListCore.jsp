          ...
          <div class="wrap-vid">
                ...
                <logic:notEmpty name="forumMessage" property="messageUrlVO.thumbnailUrl">                  
                  <div class="thumbn">
                   ...
                   <p><bean:write name="forumThread" property="rootMessage.messageVO.shortBody[150]" />. <a href="<%=request.getContextPath()%>/<bean:write name="forumThread" property="threadId"/>.html" target="_blank" class="smallgray">详细</a></p>
