...
<head>
  ...
  <meta name="Keywords" content="微服务,SOA,Java编程,DDD,分布式架构,设计模式,框架,大数据,云原生,面向对象,函数编程,SpringBoot,EDA,JEE,j2ee,web,JavaEE,DDD,CQRS,EventSourcing,javascript,Reactive,scalable,Spring,node.js" />
