...
<head>
  ...
  <meta name="Description" content="<jsp:include page="/query/tagHotList.shtml" flush="true"></jsp:include> "/>
  <meta name="Keywords" content="领域驱动设计,微服务,服务网格,Serverless,整洁架构,分布式架构,区块链,SOA,DDD,体系结构,架构,Gof设计模式,Java框架,大数据,云原生,面向对象,函数编程,SpringBoot,EDA,java,JavaEE,CQRS,eventsourcing" />
