...
&nbsp; | 微博              
   ...
   <br>
   <a href="<%=request.getContextPath()%>/account/protected/sub/subAction.shtml?subscribeType=3&subscribeId=<bean:write name="account" property="userId"/>" target="_blank" title="加关注"  >
